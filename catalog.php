...
<div class="container-fluid mt-5 mb-5">
    <div class="row p-5">
        ...
        <div class="col-sm-12 col-md-12 col-lg-6 ">
            ...
            <p>Ved du hvilke <span class="fw-bold" style="color: #C47F2A">muligheder</span> der er indenfor AI, som dækker netop <span class="fw-bold" style="color: #C47F2A">dine</span> behov?</p>

            <p>Vidste du, at du kan <span class="fw-bold" style="color: #C47F2A">effektivisere</span> interne arbejdsprocesser og <span class="fw-bold" style="color: #C47F2A">forkorte</span> produktionskæder, ved hjælp af <span class="fw-bold" style="color: #C47F2A">IA</span>?</p>
        </div>
        ...
        <div class="col-sm-12 col-md-12 col-lg-6">
            ...
            <p>Målet er, at <span class="fw-bold" style="color: #C47F2A">frigøre ressourcer</span>  i virksomheden, ved at benytte de AI løsninger der passer til jer.</p>
            <p>Løsninger, der sikrer <span class="fw-bold" style="color: #C47F2A">kvalitet</span> for slutbrugeren, borgeren, medarbejderen eller produktet.</p>
            <p>AI giver mulighed for at <span class="fw-bold" style="color: #C47F2A">øge omsætning</span>, men også at tage <span class="fw-bold" style="color: #C47F2A">ansvar</span> for omverdenen og jeres medarbejdere - uden omkostninger.</p>
